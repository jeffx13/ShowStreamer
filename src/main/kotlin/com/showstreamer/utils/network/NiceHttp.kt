...
import com.showstreamer.USER_AGENT
import com.showstreamer.utils.document
...
class NiceResponse(
    ...
    val json by lazy { JSONObject(okhttpResponse.body?.string() ?: "{}") }
    /** Return code */
    ...
    val document: Document by lazy { text.document }
...
fun OkHttpClient.Builder.ignoreAllSSLErrors(): OkHttpClient.Builder {
    ...
    sslSocketFactory(insecureSocketFactory, object : X509TrustManager {
        override fun getAcceptedIssuers(): Array<X509Certificate> = arrayOf()
        override fun checkClientTrusted(certs: Array<X509Certificate>, authType: String) = Unit
        override fun checkServerTrusted(certs: Array<X509Certificate>, authType: String) = Unit
    })
